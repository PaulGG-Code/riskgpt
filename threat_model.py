...
def create_threat_model_prompt(app_type, authentication, internet_facing, sensitive_data, app_input, operation_environment):
    prompt = f"""
...
OPERATION ENVIRONMENT: {operation_environment}
